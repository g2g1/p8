...
if(isset($_POST['submit1'])){
    ...
    $query = "INSERT INTO p8_students_registration (firstname, lastname, username, password, email, contact, sem, enrollment, status) VALUES ('$firstname','$lastname','$username','$password','$email','$contact','$sem','$enrollmentno', 'no')";

    $stmt = mysqli_query($link, $query);

    ?>
    <div class="alert alert-success col-lg-12 col-lg-push-0">
        Registered successfully, You will get email when your account is approved
    </div>
